       ...
       private PicturePreviewModel currentItemModel = null;
        ...
        public override List<CategoryItem> Items
        {
            get
            {
                ...
                if (Pictures.Count == 0)
                {
                    ImageSource = new BitmapImage(new Uri("Backgrounds/background_1.jpg", UriKind.Relative));
                    names.Add(new CategoryItem("No items to display...", "", ImageSource));
                }
                else
                {
                    foreach (Picture picture in Pictures)
                    {
                        ...
                        names.Add(new CategoryItem(picture.Name, picture.Date.ToString(), ImageSource));
                    }
                }
                return names;
            }
        ...
        public Picture getPicture(int itemIndex)
        {
